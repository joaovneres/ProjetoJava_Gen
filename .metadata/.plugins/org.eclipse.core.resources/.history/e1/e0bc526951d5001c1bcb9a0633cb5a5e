...
public class Doador extends Pessoa {
	...
	public void cadastrar(Doador objeto, List<Object> listaD) {
		...
		System.out.println("\nDigite a quantidade de livros nesta doação: ");
	...
	@Override
	public void listar(List<Object> listaD) {
		for (int i = 0; i < listaD.size(); i++) {
			System.out.println("\nDoadore " + (i + 1) + ": " + listaD.get(i));
		}
	}
