...
public class Decidir {
	public void dCadastrar(List<Aluno> listaA, List<Doador> listaD, List<Funcionario> listaF, List<Livro> listaL) {
		int x;
		while (true) {
			System.out.println("\nEscolha uma opção para cadastrar entre 1 à 4.\n" + "1-Cadastro do Alune.\n"
	...
	public void dLista(List<Aluno> listaA, List<Doador> listaD, List<Funcionario> listaF, List<Livro> listaL) {
		int x;
		while (true) {
			System.out.println("\nEscolha uma opção de listar entre 1 à 4.\n" + "1-Listar Alunes.\n"
					+ "2-Listar Doadores.\n" + "3-Listar Funcionáries.\n" + "4-Listar Livro.\n" + "0-Voltar.\n");
			try {
				Scanner scan = new Scanner(System.in);
				x = scan.nextInt();
			} catch (InputMismatchException ex) {
	...
	public void dConsultar(List<Aluno> listaA, List<Doador> listaD, List<Funcionario> listaF, List<Livro> listaL) {
		int x;
		while (true) {
			System.out.println("\nEscolha uma opção para consultar entre 1 à 4.\n" + "1-Consulta do Alune.\n"
					+ "2-Consulta do Doador.\n" + "3-Consulta do Funcionário.\n" + "4-Consulta do Livro.\n"
					+ "0-Voltar.\n");
			try {
				Scanner scan = new Scanner(System.in);
				x = scan.nextInt();
	...
	public void dAlterar(List<Aluno> listaA, List<Doador> listaD, List<Funcionario> listaF, List<Livro> listaL) {
		int x;
		while (true) {
			System.out.println("\nEscolha uma opção para alterar entre 1 à 4.\n" + "1-Alterar Alunes.\n"
					+ "2-Alterar Doadores.\n" + "3-Alterar Funcionáries.\n" + "4-Alterar Livro.\n" + "0-Voltar.\n");
			try {
				Scanner scan = new Scanner(System.in);
				x = scan.nextInt();
			} catch (InputMismatchException ex) {
	...
	public void dExcluir(List<Aluno> listaA, List<Doador> listaD, List<Funcionario> listaF, List<Livro> listaL) {
		int x;
		while (true) {
			System.out.println("\nEscolha uma opção para exlcuir entre 1 à 4.\n" + "1-Exlcuir Alune.\n"
					+ "2-Exlcuir Doador.\n" + "3-Exlcuir Funcionário.\n" + "4-Exlcuir Livro.\n" + "0-Voltar.\n");
			try {
				Scanner scan = new Scanner(System.in);
				x = scan.nextInt();
			} catch (InputMismatchException ex) {
